...
from nn.extra_modules.wtconv2d import WTConv2d
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3):
                ...
                n = 1
                   ...
                   TransformerEncoderLayer_MSMHSA, TransformerEncoderLayer_DHSA, TransformerEncoderLayer_DPB,
            ...
            m = m(*args)
            c2 = m.channel
        elif m in {SpatialAttention, CBAM, CAFM, EfficientAdditiveAttnetion
                   }:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
